 ...
 *
 * <p>
 * Configures the path-hash mode used when flooding packets.
 *
 * <p>
 * Frame layout:
 *
 ...
 *
 * <p>
 * Firmware rejects values >= 3 with ERR_CODE_ILLEGAL_ARG. On success responds
 * with RESP_OK; the new value is visible in
